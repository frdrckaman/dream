...
const tb_regimen5_5_5 = document.getElementById("tb_regimen5");
const tb_regimen6_6_6 = document.getElementById("tb_regimen6");
...
tb_regimen5_5_5.addEventListener("change", toggleElementVisibility);
tb_regimen6_6_6.addEventListener("change", toggleElementVisibility);
