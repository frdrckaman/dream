...
class Email {
    ...
    function userInvite($email, $lastname, $subject, $link)
    {
        $mail = new PHPMailer();
        $body = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        <html xmlns="http://www.w3.org/1999/xhtml" >
                            ...
                            <table class="social" width="100%">
                                <tr>
                                    <td>
                                        ...
                                        <table align="" style="padding: 20px">
                                            <tr>
                                                <td align="right"><h3 class="collapse" style="font-weight: bolder">DREAM DATA MANAGEMENT SYSTEM</h3></td>
                                            </tr>
                                        </table>
                                        <!-- /column 1 -->
                            ...
                            <div class="content">
                                <table>
                                    <tr>
                                        <td>
                                            <h3>Dear ' . $lastname . '</h3>
                                            <p class="lead">JOin the Link Below</p>
                                            
                                            <!-- Callout Panel -->
                                            <p class="callout">
                                                Click the link to join the group <a href="' . $link . '">&nbsp;Click here to join the group &raquo;</a>
                                            </p><!-- /Callout Panel -->
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <table align="left" class="column">
                                                            <tr>
                                                                <td>
                                                                    <p style="font-weight: bolder">Visit our website at : <a href="https://ctrl.uat.tz.redcs.org/">www.exit-tb.org</a></p>
                                                                    <p> </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table align="left" class="column">
                                                            <tr>
                                                                <td>
                                                                    <p style="font-weight: bolder">Send us an Email : <strong><a href="info.dream@gmail.com">info.dream@gmail.com</a></strong></p>
                                                                </td>
                                                            </tr>
                                                        </table><!-- /column 2 -->
                                                    </td>
