...
if ($user->isLoggedIn()) {
    try {
        $site_data = $override->getNews('sites', 'status', 1, 'region', 2);
        ...
        $completed = $override->getCount1('diagnosis', 'status', 1, 'tb_otcome2', 1);
...
if ($site_data) {
    ...
    $output .= '<tr>
        ...
        <td align="right"><b>' . $end_study_Total . '</b></td>
            ...
            <tr>
            <td colspan="6" align="center" style="font-size: 18px">
                            <b>Total Summary</b><br><br><hr>
                <b> Screening (' . $screened_Total . '): Eligible (' . $eligible_Total . '): Enrolled (' . $enrolled_Total . '): Completed (' . $end_study_Total . ')</b>
            </td>
        </tr>
    </table>';
}
