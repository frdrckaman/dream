                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3" style="flex: 1;">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>1. Date of enrolment</label>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>5a. Cough of >2 weeks</label>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>5b. Poor weight gain or loss of weight</label>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>5c. Coughing up blood</label>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>5d. Unexplained fever</label>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>5e. Drenching night sweats</label>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>5f. Lymph nodes in neck enlarged</label>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>5g. Contact history with infectious TB patient</label>
                                                ...
                                                <div class="col-sm-3" style="flex: 1;">
                                                    <div class="row-form clearfix">
                                                        <!-- select -->
                                                        <div class="form-group">
                                                            <label>5h. Date information collected</label>
                                                            <input class="form-control" type="date"
                                                                max="<?= date('Y-m-d'); ?>"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="form-check mt-2">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="tx_unknown_month">Unknown Month</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="form-check mt-2">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="tx_unknown_year">Unknown Year</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <input class="form-control" type="number"
                                                                        ...
                                                                        placeholder="Type Month..." min="1" max="10000" value="<?php if ($clients['ltf_months']) {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3" id="other_diseases">
                                                    <label>11. Any other relevant diseases/conditions ?</label>
                                                    <!-- radio -->
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                ...
                                                <div class="col-sm-6" id="diseases_medical">
                                                    <label>12. If yes, Select relevant diseases/medical conditions
                                                         ( Tick all that apply)
                                                    </label>
                                                    <!-- radio -->
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="diseases_specify"
                                                                id="diseases_specify" placeholder="If Other specify here..." value="<?php if ($clients['diseases_specify']) {
