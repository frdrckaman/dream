                                                ...
                                                <div class="col-3" id="other_new_reason_section">
                                                    <div class="mb-3">
                                                        <label class="form-label">3(b) If no new sample collected ,what was
                                                            the reason ?</label>
                                                        <input type="text"
                                                            value="<?php print_r($costing['other_new_reason']); ?>"
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <?php foreach ($override->get('form_completness', 'status', 1) as $value) { ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="clinic_status" id="form_status<?= $value['id']; ?>" value="<?= $value['id']; ?>" <?php if ($costing['form_status'] == $value['id']) {
                                                                                                                                                                                                            echo 'checked';
                                                ...
                                                <div class="col-sm-4" id="clinic_date_completed_section">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="date" name="clinic_date_completed" id="clinic_date_completed" value="<?php if ($costing['clinic_date_completed']) {
                                                                                                                                                                        print_r($costing['clinic_date_completed']);
                                                                                                                                                                    } ?>" />
                                                ...
                                                <div class="col-sm-4" id="clinic_date_verified_section">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="date" name="clinic_date_verified" id="clinic_date_verified" value="<?php if ($costing['clinic_date_verified']) {
                                                                                                                                                                        print_r($costing['clinic_date_verified']);
                                                                                                                                                                    } ?>" />
                                    ...
                                    <form id="screening" enctype="multipart/form-data" method="post" autocomplete="off">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <!-- Consent Date -->
                                                <div class="col-4" id="consent_date_section" style="display: none;">
                                                    <div class="mb-2">
                                                ...
                                                <div class="col-sm-4" id="screening_completed" style="display: none;">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            ...
                                                            <span id="screening_date_completed_error"
                                                                class="text-danger"></span>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-warning">
                                    ...
                                    <!-- /.card-header -->
                                    <form id="laboratory_zonal_ctlr" enctype="multipart/form-data" method="post"
                                        autocomplete="off">
                                        <div class="card-body">
                                            <hr>
                                            <div class="row">
                                                    ...
                                                    <div class=" col-12">
                                                        ...
                                                        <div class="mb-3">
                                                            <input type="hidden"
                                                                ...
                                                                id="screening_date_ctrl_zonal"
                                                                name="screening_date_ctrl_zonal" />
                                                            <input type="hidden"
                                                                value="<?= $enrollment['enrollment_date']; ?>"
                                                                id="enrollment_date_ctrl_zonal"
                                                                name="enrollment_date_ctrl_zonal" />
                                            ...
                                            <div id="culture_performed_section">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 rounded border p-3"
                                                        ...
                                                        <hr>
                                                        <label for="lj_inoculation_date" class="form-label">8. LJ Date of
                                                    ...
                                                    <div class="col-sm-6 rounded border p-3"
                                                        ...
                                                        <hr>
                                                        <label for="mgit_inoculation_date" class="form-label">8. MGIT Date
                                                            of culture inoculation</label>
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-sm-6 rounded border p-3" id="lj_results_date_section">
                                                        <label for="lj_results_date" class="form-label">9. LJ Date of
                                                    ...
                                                    <div class="col-sm-6 rounded border p-3" id="mgit_results_date_section">
                                                        <label for="mgit_results_date" class="form-label">9. MGIT Date of
                                                            culture results</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6" id="isolate_date_section">
                                                        <label for="isolate_date" class="form-label">Isolate Date</label>
                                                        <input type="date" value="<?php if ($costing['isolate_date']) {
                                                                                        print_r($costing['isolate_date']);
                                                                                    } ?>" id="isolate_date" name="isolate_date"
                                                            class="form-control" />
                                                        <span class="text-danger" id="isolate_date_error"></span>
                                                    </div>
                                                </div>
                                                <hr>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4" id="phenotypic_date_performed_section">
                                                        ...
                                                        <span class="text-danger"
                                                            id="phenotypic_date_performed_error"></span>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4" id="phenotypic_date_results_section">
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            class="form-control" <?= $disabled; ?> />
                                                        <span class="text-danger" id="phenotypic_date_results_error"></span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-6 border rounded p-3">
                                                    ...
                                                    <div id="second_line_section">
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            class="form-control" />
                                                        <span class="text-danger" id="second_line_lpa_date_error"></span>
                                                        <hr>
                                        ...
                                        <div class="card-footer">
                                            <a href="info.php?id=6&status=<?= $_GET['status']; ?>&sid=<?= $_GET['sid']; ?>&facility_id=<?= $_GET['facility_id']; ?>&page=<?= $_GET['page']; ?>"
                                                class="btn btn-default">Back</a>
                                            <?php
                                            if (($user->data()->site_id == 6 || $user->data()->site_id == 13 || $user->data()->site_id == 20 || $user->data()->site_id == 22) && $user->data()->position != 13) {
                                            ?>
                                                            ...
                                                            <?php foreach ($override->get('form_completness', 'status', 1) as $value) { ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="<?= $value['id']; ?>"
                                                                        <?php if ($costing['form_status'] == $value['id']) {
                                                                            'checked';
                                                                        } ?> required>
                                                                    <label
                                                                        class="form-check-label"><?= $value['name']; ?></label>
                                                ...
                                                <div class="col-sm-4" id="diagnosis_date_verified_status">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>Verified Date</label>
                                                            <input class="form-control" type="date" name="date_verified"
                                                                id="diagnosis_date_verified" samson@2025
                                                                value="<?php if ($costing['date_verified']) {
                                                                            print_r($costing['date_verified']);
                                                                        } ?>" />
                                                ...
                                                <div class="col-sm-3" style="flex: 1;">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="consent_date_enrollment"
                                                                id="consent_date_enrollment"
                                                                value="<?= $screening['consent_date'] ?>" />
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <input class="form-control" type="number" name="tx_year"
                                                                        id="tx_year" placeholder="Type Year..." value="<?php if ($clients['tx_year']) {
