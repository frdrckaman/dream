                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4" id="sequence_done">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        ...
                                                        <label for="sequence_date" id="sequence_date1" class="form-label">Date done</label>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php foreach ($override->get('sequence_type', 'status', 1) as $value) { ?>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="sequence_type2" id="sequence_type6_7_<?= $value['id']; ?>" value="<?= $value['id']; ?>" <?php if ($medications3[0]['sequence_type'] == $value['id']) {
                                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                                    } ?>>
                                                                        <label class="form-check-label"><?= $value['name']; ?></label>
                                                                    </div>
                                                            ...
                                                            <td id="sequence_number6_1">
                                                                <input type="text" name="sequence_number2" id="sequence_number6_2" value="<?php if ($medications3[0]['sequence_number']) {
                                                            ...
                                                            <td id="ct_value6_1">
                                                                <input type="number" name="ct_value2" id="ct_value6_2" class="form-control" min="0" max="99" value="<?php if ($medications3[0]['ct_value']) {
                                                 ...
                                                 <div class="col-sm-6" id="respiratory_verified_by">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="respiratory_verified_by" name="respiratory_verified_by" class="form-control" required>
                                                                <?php $enrollment_completed = $override->get('user', 'id', $costing['respiratory_verified_by'])[0]; ?>
                                                                <option value="<?= $enrollment_completed['id'] ?>"><?php if ($costing['respiratory_verified_by']) {
                                                ...
                                                <div class="col-sm-6" id="respiratory_verified_date">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="date" name="respiratory_verified_date" id="respiratory_verified_date" value="<?php if ($costing['respiratory_verified_date']) {
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4" id="wrd_test2_0">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <?php foreach ($override->get('wrd_test', 'status', 1) as $value) { ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="wrd_test2_0" id="wrd_test2_<?= $value['id']; ?>" value="<?= $value['id']; ?>" <?php if ($costing['wrd_test'] == $value['id']) {
                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                        } ?> required>
                                                                    <label class="form-check-label"><?= $value['name']; ?></label>
                                                                </div>
                                                ...
                                                <div class="col-sm-4" id="sequence_done2_0">
                                                    <label for="sequence_done2_0" class="form-label">72. If none at the facility has it been done at sequence lab?
                                                    </label>
                                                    <!-- radio -->
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <?php foreach ($override->get('yes_no', 'status', 1) as $value) { ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="sequence_done2_0" id="sequence_done2_<?= $value['id']; ?>" value="<?= $value['id']; ?>" <?php if ($costing['sequence_done'] == $value['id']) {
                                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                                } ?>>
                                                                    <label class="form-check-label"><?= $value['name']; ?></label>
                                                                </div>
                                                            <?php } ?>
                                                            <br>
                                                            <button type="button" onclick="unsetRadio('sequence_done2_0')">Unset</button>
                                                        </div>
                                                        <br>
                                                        <br>
                                                ...
                                                <div class="col-sm-4" id="sequence_type2_0">
                                                    <label for="sequence_type2_0" class="form-label">73. If yes (If Invalid/Error/No results skip next two qtn)</label>
                                                    <!-- radio -->
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <?php foreach ($override->get('sequence_type', 'status', 1) as $value) { ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="sequence_type2_0" id="sequence_type2_<?= $value['id']; ?>" value="<?= $value['id']; ?>" <?php if ($costing['sequence_type'] == $value['id']) {
                                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                                } ?>>
                                                                    <label class="form-check-label"><?= $value['name']; ?></label>
                                                                </div>
                                                            <?php } ?>
                                                            <button type="button" onclick="unsetRadio('sequence_type2_0')">Unset</button>
                                                        </div>
                                                        <label for="sequence_number2_1" id="sequence_number2_1" class="form-label">(If error, what code/number??) </label>
                                                        <input type="text" value="<?php if ($costing['sequence_number']) {
                                                                                        print_r($costing['sequence_number']);
                                                                                    } ?>" id="sequence_number2_2" name="sequence_number2_2" class="form-control" placeholder="Enter here" />
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2" id="mtb_detection2_0">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <?php foreach ($override->get('mtb_detection', 'status', 1) as $value) { ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="mtb_detection2_0" id="mtb_detection2_<?= $value['id']; ?>" value="<?= $value['id']; ?>" <?php if ($costing['mtb_detection'] == $value['id']) {
                                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                                } ?>>
                                                                    <label class="form-check-label"><?= $value['name']; ?></label>
                                                                </div>
                                                ...
                                                <div class="col-sm-2" id="rif_resistance2_0">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <?php foreach ($override->get('rif_resistance', 'status', 1) as $value) { ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="rif_resistance2_0" id="rif_resistance2_<?= $value['id']; ?>" value="<?= $value['id']; ?>" <?php if ($costing['rif_resistance'] == $value['id']) {
                                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                                    } ?>>
                                                                    <label class="form-check-label"><?= $value['name']; ?></label>
                                                                </div>
                                                    ...
                                                    <button type="button" onclick="unsetRadio('rif_resistance2_0')">Unset</button>
                                                ...
                                                <div class="col-sm-3" id="test_repeatition2_0">
                                                    <label for="test_repeatition2_0" class="form-label">77. If Invalid/Error/No result/Indeterminate, was the test repeated?
                                                    </label>
                                                    <!-- radio -->
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <?php foreach ($override->get('yes_no', 'status', 1) as $value) { ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="test_repeatition2_0" id="test_repeatition2_<?= $value['id']; ?>" value="<?= $value['id']; ?>" <?php if ($costing['test_repeatition'] == $value['id']) {
                                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                                        } ?>>
                                                                    <label class="form-check-label"><?= $value['name']; ?></label>
                                                                </div>
                                                    ...
                                                    <button type="button" onclick="unsetRadio('test_repeatition2_0')">Unset</button>

                                                </div>

                                                <div class="col-sm-3" id="microscopy_reason2_0">
                                                    <label for="microscopy_reason2_0" class="form-label">78. If no reason(s) </label>
                                                    <!-- radio -->
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <?php foreach ($override->get('microscopy_reason', 'status', 1) as $value) { ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="microscopy_reason2_0" id="microscopy_reason2_<?= $value['id']; ?>" value="<?= $value['id']; ?>" <?php if ($costing['microscopy_reason'] == $value['id']) {
                                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                                        } ?>>
                                                                    <label class="form-check-label"><?= $value['name']; ?></label>
                                                                </div>
                                            ...
                                            <div class="row">
                                                 ...
                                                 <div class="col-sm-6" id="non_respiratory_verified_by">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>40. This form was Verified by (name) </label>
                                                            <select id="non_respiratory_verified_by" name="non_respiratory_verified_by" class="form-control" required>
                                                                <?php $enrollment_completed = $override->get('user', 'id', $costing['non_respiratory_verified_by'])[0]; ?>
                                                                <option value="<?= $enrollment_completed['id'] ?>"><?php if ($costing['non_respiratory_verified_by']) {
                                                                                                                        print_r($enrollment_completed['firstname'] . ' ' . $enrollment_completed['lastname']);
                                                                                                                    } else {
                                                                                                                        echo 'Select';
                                                                                                                    } ?>
                                                ...
                                                <div class="col-sm-6" id="non_respiratory_verified_date">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>40. Form Verified  Date</label>
                                                            <input class="form-control" type="date" name="non_respiratory_verified_date" id="non_respiratory_verified_date" value="<?php if ($costing['non_respiratory_verified_date']) {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        ...
                                                        <button type="button" onclick="unsetRadio('culture_done')">Unset</button>
                                                ...
                                                <div class="col-sm-3" id="sample_type2">
                                                    ...
                                                    <button type="button" onclick="unsetRadio('sample_type2')">Unset</button>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3" id="lj_results">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        ...
                                                        <button type="button" onclick="unsetRadio('lj_results')">Unset</button>
                                                ...
                                                <div class="col-sm-3" id="mgit_results">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        ...
                                                        <button type="button" onclick="unsetRadio('mgit_results')">Unset</button>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4" id="phenotypic_done">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        ...
                                                        <button type="button" onclick="unsetRadio('phenotypic_done')">Unset</button>
                                                ...
                                                <div class="col-sm-4" id="phenotypic_method">
                                                    ...
                                                    <button type="button" onclick="unsetRadio('phenotypic_method')">Unset</button>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3" id="levofloxacin">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('levofloxacin')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="moxifloxacin">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('moxifloxacin')">Unset</button>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3" id="pyrazinamide">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('pyrazinamide')">Unset</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3" id="streptomycin">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('streptomycin')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="prothionamide">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('prothionamide')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="para_aminosalicylic_acid">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('para_aminosalicylic_acid')">Unset</button>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6" id="genotyping_done">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        ...
                                                        <button type="button" onclick="unsetRadio('genotyping_done')">Unset</button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6" id="genotyping_asay">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        ...
                                                        <button type="button" onclick="unsetRadio('genotyping_asay')">Unset</button>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6" id="nanopore_sequencing_done">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        ...
                                                        <button type="button" onclick="unsetRadio('nanopore_sequencing_done')">Unset</button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6" id="nanopore_sequencing">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        ...
                                                        <button type="button" onclick="unsetRadio('nanopore_sequencing')">Unset</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3" id="rifampicin3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('rifampicin3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="isoniazid3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('isoniazid3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="levofloxacin3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('levofloxacin3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="moxifloxacin3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('moxifloxacin3')">Unset</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3" id="bedaquiline3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('bedaquiline3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="linezolid3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('linezolid3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="clofazimine3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('clofazimine3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="cycloserine3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('cycloserine3')">Unset</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3" id="terizidone3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('terizidone3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="ethambutol3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('ethambutol3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="delamanid3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('delamanid3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="pyrazinamide3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('pyrazinamide3')">Unset</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3" id="imipenem3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('imipenem3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="cilastatin3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('cilastatin3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="meropenem3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('meropenem3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="amikacin3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('amikacin3')">Unset</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3" id="streptomycin3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('streptomycin3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="ethionamide3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('ethionamide3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="prothionamide3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('prothionamide3')">Unset</button>
                                                    ...
                                                    <div class="col-sm-3" id="para_aminosalicylic_acid3">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <button type="button" onclick="unsetRadio('para_aminosalicylic_acid3')">Unset</button>
                                            ...
                                            <div class="row">
                                                 ...
                                                 <div class="col-sm-6" id="diagnosis_test_verified_by">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>40. This form was Verified by (name) </label>
                                                            <select id="diagnosis_test_verified_by" name="diagnosis_test_verified_by" class="form-control" required>
                                                                <?php $enrollment_completed = $override->get('user', 'id', $costing['diagnosis_test_verified_by'])[0]; ?>
                                                                <option value="<?= $enrollment_completed['id'] ?>"><?php if ($costing['diagnosis_test_verified_by']) {
                                                                                                                        print_r($enrollment_completed['firstname'] . ' ' . $enrollment_completed['lastname']);
                                                                                                                    } else {
                                                                                                                        echo 'Select';
                                                                                                                    } ?>
                                                ...
                                                <div class="col-sm-6" id="diagnosis_test_verified_date">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>40. Form Verified  Date</label>
                                                            <input class="form-control" type="date" name="diagnosis_test_verified_date" id="diagnosis_test_verified_date" value="<?php if ($costing['diagnosis_test_verified_date']) {
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="tb_diagnosis_hides">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4" id="tb_treatment">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            <div class="form-group">
                                                                ...
                                                                <?php } ?>
                                                                <button type="button" onclick="unsetRadio('tb_treatment')">Unset</button>
                                                            </div>


                                                            <label for="tb_treatment_date" id="tb_treatment_date1" class="form-label">What was treatment start date ?</label>
                                                            <input type="date" value="<?php if ($costing['tb_treatment_date']) {
                                                                                            print_r($costing['tb_treatment_date']);
                                                                                        } ?>" id="tb_treatment_date" name="tb_treatment_date" class="form-control" placeholder="Enters here" />
                                                            <label for="tb_facility" id="tb_facility1" class="form-label">(Name health facility):</label>
                                                            <input type="text" value="<?php if ($costing['tb_facility']) {
                                                                                            print_r($costing['tb_facility']);
                                                                                        } ?>" id="tb_facility" name="tb_facility" class="form-control" placeholder="Enter heres" />
                                                            <label for="tb_reason" id="tb_reason1" class="form-label">reason (specify):</label>
                                                    ...
                                                    <div class="col-sm-4" id="tb_regimen">
                                                        ...
                                                        <label for="tb_regimen_other" id="tb_regimen_other1" class="form-label">Regimens specify</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3" id="regimen_changed">
                                                        ...
                                                        <div class="row-form clearfix">
                                                            ...
                                                            <label for="regimen_changed__date" id="regimen_changed__date1" class="form-label">1st (Date??), </label>
                                                            ...
                                                            <label for="regimen_removed_name" id="regimen_removed_name1" class="form-label">Drug(s) removed </label>
                                                            ...
                                                            <label for="regimen_added_name" id="regimen_added_name1" class="form-label">Drugs added </label>
                                                            ...
                                                            <label for="regimen_changed__reason" id="regimen_changed__reason1" class="form-label">Reason for change </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4" id="tb_diagnosis_made2">
                                                    ...
                                                    <button type="button" onclick="unsetRadio('tb_diagnosis_made2')">Unset</button>
                                                ...
                                                <div class="col-sm-4" id="laboratory_test_used221111">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            ...
                                                            <?php } ?>
                                                            <button type="button" onclick="unsetRadio('laboratory_test_used2')">Unset</button>
                                                        </div>
                                                        <label for="microscopy_reason_other" id="microscopy_reason_other1" class="form-label">If Other Mention</label>
                                                        <input type="text" value="<?php if ($costing['microscopy_reason_other']) {
                                                                                        print_r($costing['microscopy_reason_other']);
                                            ...
                                            <div class="row">
                                                 <div class="col-sm-6" id="diagnosis_test_verified_by">
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>40. This form was Verified by (name) </label>
                                                            <select id="diagnosis_verified_by" name="diagnosis_verified_by" class="form-control" required>
                                                                <?php $enrollment_completed = $override->get('user', 'id', $costing['diagnosis_verified_by'])[0]; ?>
                                                                <option value="<?= $enrollment_completed['id'] ?>"><?php if ($costing['diagnosis_verified_by']) {
                                                                                                                        print_r($enrollment_completed['firstname'] . ' ' . $enrollment_completed['lastname']);
                                                                                                                    } else {
                                                                                                                        echo 'Select';
                                                                                                                    } ?>
                                                ...
                                                <div class="col-sm-6" id="diagnosis_verified_date">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <label>40. Form Verified  Date</label>
                                                            <input class="form-control" type="date" name="diagnosis_verified_date" id="diagnosis_verified_date" value="<?php if ($costing['diagnosis_verified_date']) {
                                             ...
                                             <div class="col-sm-4" id="enrollment_completness">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            <?php foreach ($override->get('form_completness', 'status', 1) as $value) { ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="enrollment_completness" id="enrollment_completness<?= $value['id']; ?>" value="<?= $value['id']; ?>" <?php if ($costing['enrollment_completness'] == $value['id']) {
                                                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                                                } ?> required>
                                                                    <label class="form-check-label"><?= $value['name']; ?></label>
                                                                </div>
                                                        ...
                                                        <button type="button" onclick="unsetRadio('enrollment_completness')">Unset</button>
                                                ...
                                                <div class="col-sm-6" id="enrollment_completed_date">
                                                    ...
                                                    <div class="row-form clearfix">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="date" name="enrollment_completed_date" id="enrollment_completed_date" value="<?php if ($clients['enrollment_completed_date']) {
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-warning">
                                    ...
                                    <form id="validation" enctype="multipart/form-data" method="post" autocomplete="off">
                                        <div class="card-body">
                                            ...
                                            <div id="repeatableSectionContainer">
                                                <div id="repeatableSection" class="repeatableSection">
                                                    <div class="row">
                                                        <input type="hidden" name="row_id[]" value=""> <!-- Hidden input to store the row ID for update/delete -->
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <div class="form-group">
                                                                <?php foreach ($override->get('wrd_test', 'status', 1) as $value) { ?>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="wrd_test[0]" id="wrd_test<?= $value['id']; ?>" value="<?= $value['id']; ?>">
                                                                        <label class="form-check-label"><?= $value['name']; ?></label>
                                                                    </div>
                                                                <?php } ?>
                                                        ...
                                                        <button type="button" class="btn btn-danger" onclick="removeSection(this)">Delete Row</button>
                                                    </div>
                                                    <hr>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer">
                                            <a href="info.php?id=4&cid=<?= $_GET['cid']; ?>&study_id=<?= $_GET['study_id']; ?>&status=<?= $_GET['status']; ?>" class="btn btn-default">Back</a>
                                            <input type="submit" name="add_respiratory_test" value="Submit" class="btn btn-primary">
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
