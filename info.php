                                                        ...
                                                        <form method="post">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <input type="submit" name="delete_positions" value="Delete"
                                                                        class="btn btn-danger">
                                                                    <button class="btn btn-default" data-dismiss="modal"
                                                                        aria-hidden="true">Close</button>
                                                                </div>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <?php } else { ?>
                                                    <td class="text-center">
                                                        <a href="#" class="btn btn-danger"> <i class="ri-edit-box-line"></i>Not
                                                            Active</a>
                                                    </td>
                                                <?php } ?>
                                                <td>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <form method="post">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <input type="hidden" name="id" value="<?= $value['id'] ?>">
                                                                    <input type="submit" name="delete_facility" value="Delete"
                                                                        class="btn btn-danger">
                                                                    <button class="btn btn-default" data-dismiss="modal"
                                                                        aria-hidden="true">Close</button>
                                                                </div>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <form method="post">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <input type="hidden" name="id" value="<?= $value['id'] ?>">
                                                                    <input type="submit" name="restore_facility" value="Restore"
                                                                        class="btn btn-warning">
                                                                    <button class="btn btn-default" data-dismiss="modal"
                                                                        aria-hidden="true">Close</button>
                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-6">
                                                                            <div class="mb-2">
                                                                                ...
                                                                                <select class="form-control" id="visit_status"
                                                                                    name="visit_status" style="width: 100%;"
                                                                                    required>
                                                                                    <option
